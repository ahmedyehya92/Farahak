...
import com.kywline.far7a.helper.CitySearch;
import com.kywline.far7a.helper.CitySearchAdapter;
import com.kywline.far7a.helper.Gov;
import com.kywline.far7a.helper.GovAdapter;
...
public class SearchActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLayout = (LinearLayout) findViewById(R.id.load_layout_search);
        loadLayout.setVisibility(View.VISIBLE);
        mprogressBar = (ProgressBar) findViewById(R.id.progBar_search);
